...
const usRegion: RegionConfig = {
  ...
  banks: [
    { id: 'chase', nameKey: 'banks.chase' },
    { id: 'bofa', nameKey: 'banks.bofa' },
    { id: 'wells', nameKey: 'banks.wells' },
    { id: 'citi', nameKey: 'banks.citiUS' },
    { id: 'usbank', nameKey: 'banks.usbank' },
    { id: 'capital', nameKey: 'banks.capital' },
    { id: 'td', nameKey: 'banks.td' },
    { id: 'pnc', nameKey: 'banks.pnc' },
  ...
  cardCompanies: [
    ...
    { id: 'discover', nameKey: 'cardCompanies.discover', color: '#FF6000' },
    { id: 'etc', nameKey: 'cardCompanies.etc', color: '#9CA3AF' },
  ],

  billingRules: {}, // US cards use statement closing dates, not fixed billing periods
